...
async def photo_received(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        logger.exception("Certificate generation/send failed for user %s", telegram_id)
        await update.message.reply_text(
            "⚠️ Something went wrong while creating your certificate. "
            "Please try again with /start, or contact an admin if this keeps happening."
        )
        return ConversationHandler.END
